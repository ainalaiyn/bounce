...
# заселение последнего ряда землей
...
# кнопки создания загрузки и сохранения
...
while running:
	...
	# для рисования нескольких смежных отрезков
